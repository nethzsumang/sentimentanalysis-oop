...
class TobaccoController(Controller):
    ...
    def fetch_tweets(o_app, a_params):
        ...
        if not data['result']:
            ...
            return Controller.redirect('TobaccoController@analyze', {
                'data': data['data'],
                'cached': False
            })
    ...
    def analyze(o_app, a_params):
        ...
        return Controller.redirect('TobaccoController@save_data', {
            'data': data,
    ...
    def save_data(o_app, a_params):
        ...
        return Controller.redirect('TobaccoController@show_graph', {
            'data': data
        })
